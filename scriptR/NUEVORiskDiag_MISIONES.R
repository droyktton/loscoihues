...
DatosMinSalTodo<-read.csv("CasosMisiones.csv")
## SELECCIONO SOLO LOS CONFIRMADOS
DatosMinSal<-DatosMinSalTodo %>% filter(clasificacion_resumen =="Confirmado")


#####
localidades<-c("Misiones","Capital","Oberá","Iguazú")
Poblocalidades<-c(1261294,371424,121727,99849) #estimado indec al 2020
