...
DatosMinSalTodo<-read.csv("CasosCatamarca.csv")
## SELECCIONO SOLO LOS CONFIRMADOS
DatosMinSal<-DatosMinSalTodo %>% filter(clasificacion_resumen =="Confirmado")


#####
localidades<-c("Catamarca","Capital","Valle Viejo","Belén")
Poblocalidades<-c(415438,183406,31788,25209) #estimado indec al 2020
