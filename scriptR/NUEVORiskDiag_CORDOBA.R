...
DatosMinSalTodo<-read.csv("CasosCordoba.csv")
## SELECCIONO SOLO LOS CONFIRMADOS
DatosMinSal<-DatosMinSalTodo %>% filter(clasificacion_resumen =="Confirmado")
#####
localidades<-c("Córdoba","Capital","Colón","San Javier","Punilla","Santa María")
Poblocalidades<-c(3760450,1453684,301889,60165,213136,119033) #estimado indec al 2020
...
posCoordsVec2 <- c(ymd("2020-05-27"),ymd("2020-08-01"))
