...
DatosMinSalTodo<-read.csv("CasosLaRioja.csv")
## SELECCIONO SOLO LOS CONFIRMADOS
DatosMinSal<-DatosMinSalTodo %>% filter(clasificacion_resumen =="Confirmado")


#####
localidades<-c("La Rioja","Capital","Chamical","Chilecito")
Poblocalidades<-c(393531,223101,15664,59812) #estimado indec al 2020
