...
DatosMinSalTodo<-read.csv("CasosSantaFe.csv")
## SELECCIONO SOLO LOS CONFIRMADOS
DatosMinSal<-DatosMinSalTodo %>% filter(clasificacion_resumen =="Confirmado")
#####
localidades<-c("Santa Fe","La Capital","Rosario","Caseros", "General López")
Poblocalidades<-c(3536418,583368,1291010,89297,211950) #estimado indec al 2020
