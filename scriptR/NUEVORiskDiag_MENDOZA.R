...
DatosMinSalTodo<-read.csv("CasosMendoza.csv")
## SELECCIONO SOLO LOS CONFIRMADOS
DatosMinSal<-DatosMinSalTodo %>% filter(clasificacion_resumen =="Confirmado")
#####
localidades<-c("Mendoza","Capital","Las Heras","Luján de Cuyo", "Guaymallén","San Martín")
Poblocalidades<-c(1990338,119854,235699,143320,332468,135003) #estimado indec al 2020
names(Poblocalidades)<-localidades

nombreprovinciasinacento<-strsplit(stri_trans_general(localidades[1],"Latin-ASCII")," ")
...
posCoordsVec2 <- c(ymd("2020-06-01"),ymd("2020-08-05"))
