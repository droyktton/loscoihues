...
DatosMinSalTodo<-read.csv("CasosSantiagoDelEstero.csv")
## SELECCIONO SOLO LOS CONFIRMADOS
DatosMinSal<-DatosMinSalTodo %>% filter(clasificacion_resumen =="Confirmado")


#####
localidades<-c("Santiago del Estero","Capital","Banda")
Poblocalidades<-c(978313,298076,163370) #estimado indec al 2020
