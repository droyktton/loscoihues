...
DatosMinSalTodo<-read.csv("CasosProvBuenosAires.csv")
...
localidades<-c("Buenos Aires","La Matanza","Avellaneda","Lanús","Lomas de Zamora","Quilmes","La Plata","General Pueyrredón","Bahía Blanca")
Poblocalidades<-c(17541141,2281194,356392,462827,648312,664783,713947,656456,310095) #estimado indec al 2020
...
posCoordsVec <- c(ymd("2020-06-05"),ymd("2020-03-15"))
posCoordsVec2 <- c(ymd("2020-05-01"),ymd("2020-08-15"))
