...
DatosMinSalTodo<-read.csv("CasosSanJuan.csv")
## SELECCIONO SOLO LOS CONFIRMADOS
DatosMinSal<-DatosMinSalTodo %>% filter(clasificacion_resumen =="Confirmado")


#####
localidades<-c("San Juan","Capital","Rawson","Chimbas")
Poblocalidades<-c(781217,107401,126870,106627) #estimado indec al 2020
