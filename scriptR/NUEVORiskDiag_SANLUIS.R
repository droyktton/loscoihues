...
DatosMinSalTodo<-read.csv("CasosSanLuis.csv")
## SELECCIONO SOLO LOS CONFIRMADOS
DatosMinSal<-DatosMinSalTodo %>% filter(clasificacion_resumen =="Confirmado")


#####
localidades<-c("San Luis","La Capital","General Pedernera")
Poblocalidades<-c(508328,242908,145471) #estimado indec al 2020
