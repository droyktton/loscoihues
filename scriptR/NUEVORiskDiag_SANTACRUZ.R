...
DatosMinSalTodo<-read.csv("CasosSantaCruz.csv")
...
localidades<-c("Santa Cruz","Güer Aike","Lago Argentino")
Poblocalidades<-c(365698,139354,30540) #estimado indec al 2020
