...
DatosMinSalTodo<-read.csv("CasosCorrientes.csv")
## SELECCIONO SOLO LOS CONFIRMADOS
DatosMinSal<-DatosMinSalTodo %>% filter(clasificacion_resumen =="Confirmado")


#####
localidades<-c("Corrientes","Capital","Goya","Santo Tomé")
Poblocalidades<-c(1120801,410878,98213,73143) #estimado indec al 2020
