...
DatosMinSalTodo<-read.csv("CasosTucuman.csv")
## SELECCIONO SOLO LOS CONFIRMADOS
DatosMinSal<-DatosMinSalTodo %>% filter(clasificacion_resumen =="Confirmado")
#####
localidades<-c("Tucumán","Capital","Cruz Alta","Tafí Viejo")
Poblocalidades<-c(1694656,605767,219826,150121) #estimado indec al 2020
...
posCoordsVec <- c(ymd("2020-06-15"),ymd("2020-04-01"))
posCoordsVec2 <- c(ymd("2020-05-01"),ymd("2020-07-01"))
