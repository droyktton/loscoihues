...
DatosMinSalTodo<-read.csv("CasosJujuy.csv")
## SELECCIONO SOLO LOS CONFIRMADOS
DatosMinSal<-DatosMinSalTodo %>% filter(clasificacion_resumen =="Confirmado")
#####
localidades<-c("Jujuy","El Carmen","Dr. Manuel Belgrano","Ledesma","Susques")
Poblocalidades<-c(770881,116567,308821,89309,4127) #estimado indec al 2020
...
posCoordsVec2 <- c(ymd("2020-04-23"),ymd("2020-06-15"))
