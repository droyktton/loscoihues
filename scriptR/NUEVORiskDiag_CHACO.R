...
DatosMinSalTodo<-read.csv("CasosChaco.csv")
## SELECCIONO SOLO LOS CONFIRMADOS
DatosMinSal<-DatosMinSalTodo %>% filter(clasificacion_resumen =="Confirmado")
#####
localidades<-c("Chaco","San Fernando")
Poblocalidades<-c(1204541,442642) #estimado indec al 2020
...
#}else{
  write.csv(riesgoTODAS[[j]],paste("Riesgo",nombresparaarchivo[[1]][1],nombresparaarchivo[[1]][2],sep=""),row.names = FALSE)
#}
}
